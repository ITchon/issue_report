            ...
            <form class="table form form-horizontal container" action="<?php echo base_url()?>user/insert" method="post" data-toggle="validator">
                  ...
                  <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating"><h5><i class="fa fa-user"> Username</h5></i></label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating"><h5>Password</h5></label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating"><h5>Firstname</h5></label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating"><h5>Lastname</h5></label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating"><h5>Email</h5></label>
